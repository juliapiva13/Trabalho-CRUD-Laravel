...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1><i class="bi bi-car-front"></i> Novo Veículo</h1>
        ...
        <form action="{{ route('admin.veiculos.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" class="form-control @error('ano_fabricacao') is-invalid @enderror" id="ano_fabricacao" name="ano_fabricacao" value="{{ old('ano_fabricacao') }}" min="1900" max="{{ date('Y') + 1 }}" required>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" class="form-control @error('quilometragem') is-invalid @enderror" id="quilometragem" name="quilometragem" value="{{ old('quilometragem') }}" min="0" required>
                    @error('quilometragem')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" class="form-control @error('valor') is-invalid @enderror" id="valor" name="valor" value="{{ old('valor') }}" min="0" required>
                @error('valor')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="url" class="form-control @error('foto_2') is-invalid @enderror" id="foto_2" name="foto_2" value="{{ old('foto_2') }}" required>
                    @error('foto_2')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="url" class="form-control @error('foto_3') is-invalid @enderror" id="foto_3" name="foto_3" value="{{ old('foto_3') }}" required>
                    @error('foto_3')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <input type="url" class="form-control @error('foto_4') is-invalid @enderror" id="foto_4" name="foto_4" value="{{ old('foto_4') }}">
                    @error('foto_4')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
